...
public class ChatActivity extends BaseActivity implements ChatView  {
    ...
    public static void navToChat(Context context, String identify,String name,String avatar, TIMConversationType type){
...
//        UIUtils.showToast(identify);
        ...
        if (!FriendshipInfo.getInstance().isFriend(identify)){
            ...
            req.setRemark("");
            req.setFriendGroup(getString(R.string.default_group_name));
            reqList.add(req);
...
//                    Log.e("livelog", "identifier: " + res.getIdentifier() + " nickName: " + res.getNickName()
//                            + " remark: " + res.getRemark() + "faceurl: " + res.getFaceUrl());
//                }
//            }
//        });

//        TIMFriendshipManager.getInstance().searchFriend("10001", new TIMValueCallBack<TIMUserProfile>() {
//            @Override
...
//                UIUtils.showToast(profile.getFaceUrl() + "--" +profile.getNickName());
//            }
//        });
        ...
        adapter = new ChatAdapter(this, R.layout.item_message, messageList,avatar);
        ...
        switch (type) {
            case C2C:
//                title.setMoreImg(R.drawable.icon_person);
                if (FriendshipInfo.getInstance().isFriend(identify)){
...
//                            startActivity(person);
                    ...
                    if (TextUtils.isEmpty(name)){
                        ...
                        title.setTitleText( titleStr = name);
                    }
                }
                break;
            case Group:
