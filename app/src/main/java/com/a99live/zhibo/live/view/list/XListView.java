package com.a99live.zhibo.live.view.list;
...
//    private static final String TAG = "XListView";
    ...
    public void updateRefreshTime() {
        mHeaderTime.setText(TimeUtils.timeForDay(System.currentTimeMillis() / 1000));
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
                            long id) {
        if (mOnItemClickListener != null && position > 0 && position < getCount() - getFooterViewsCount()) {
