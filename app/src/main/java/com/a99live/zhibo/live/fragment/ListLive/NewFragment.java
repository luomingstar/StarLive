...
/**
 * Created by fuyk on 2016/12/12.
 */

public class NewFragment extends BaseFragment implements XListView.IXListViewListener, AdapterView.OnItemClickListener {
    ...
    private void getNewList() {
        ...
        roomProtocol.getLiveList(params)
    ...
    private void initPage(String data) {
        ...
        if (listMapByJson.size()>0){//有数据
            ...
            if (fragmentAdapter == null) {
                fragmentAdapter = new FragmentAdapter(getActivity(), listMapByJson, YMClick.NEWPAGE_HEAD_IMG);
