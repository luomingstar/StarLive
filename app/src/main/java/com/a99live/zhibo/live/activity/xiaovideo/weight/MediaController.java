...
//    private PopupWindow mWindow;
 ...
 private FrameLayout root;
    public MediaController(FrameLayout root,Context context) {
        super(context);
        this.root = root;
...
//    }
    ...
    protected View makeControllerView() {
       return LayoutInflater.from(mContext).inflate(R.layout.mediaplay_controller,this);
...
//            }
//        }
        FrameLayout out = (FrameLayout) v.findViewById(R.id.out);
        ...
        mPauseButton = (ImageButton) v.findViewById(R.id.startPause);
        ...
        mEndTime = (TextView) v.findViewById(R.id.seek_right);
        mCurrentTime = (TextView) v.findViewById(R.id.seek_left);
    }
...
//        mProgress.setProgress(0);
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying())
            mPauseButton.setBackgroundResource(R.drawable.play_pause2);
        else
            mPauseButton.setBackgroundResource(R.drawable.play_start2);
    }
...
//                    mWindow.showAtLocation(videoView, Gravity.BOTTOM,
//                            anchorRect.left, 0);
                } else {
                    Rect anchorRect = new Rect(location[0], location[1],
        ...
        if (mShowing) {
            ...
            try {
                ...
                if (mFromXml)
                    ...
                    mRoot.setVisibility(GONE);//mWindow.dismiss();
