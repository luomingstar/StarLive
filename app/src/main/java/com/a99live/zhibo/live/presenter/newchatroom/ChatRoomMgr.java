...
// */
//public class ChatRoomMgr implements TIMMessageListener {
//
...
//        private static ChatRoomMgr instance = new ChatRoomMgr();
//    }
//
...
//            sendJson.put("userId", userInfo.getData().getUcode());
//            sendJson.put("nickName", userInfo.getData().getNickname());
//            sendJson.put("headPic", userInfo.getData().getAvatar());
