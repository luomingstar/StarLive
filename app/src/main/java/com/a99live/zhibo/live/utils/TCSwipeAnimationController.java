...
public class TCSwipeAnimationController {
    ...
    public TCSwipeAnimationController(Context context) {
        ...
        animation= AnimationUtils.loadAnimation(mContext, R.anim.anim_slice_in_right);   //得到一个LayoutAnimationController对象；
        animation.setDuration(150);
        animation.setInterpolator(new AccelerateDecelerateInterpolator());
        controller = new LayoutAnimationController(animation);   //设置控件显示的顺序；
