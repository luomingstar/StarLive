 ...
 */
package com.a99live.zhibo.live.view.customviews;
...
//        parent.addView(child, new ViewGroup.LayoutParams(mConfig.heartWidth, mConfig.heartHeight));
        int dimen = UIUtils.getDimen(R.dimen.dp_35);//设置点赞心得大小
        parent.addView(child, new ViewGroup.LayoutParams(dimen, dimen));
